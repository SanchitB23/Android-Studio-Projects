...
public class JsonQuery {
    ...
    public static final String LOG_TAG = JsonQuery.class.getSimpleName();
...
*/
    ...
    /**
     * Create a private constructor because no one should ever create a {@link JsonQuery} object.
     * This class is only meant to hold static variables and methods, which can be accessed
     * directly from the class name @link com.example.android.quakereport.JsonQuery (and an object instance of QueryUtils is not needed).
     */
    private JsonQuery() {
    }

    /**
     * Return a list of {@link com.example.android.quakereport.Detail} objects that has been built up from
     * parsing a JSON response.
     */
    private static ArrayList<Detail> extractEarthquakesFromJson(String jsonResponse) {

        // Create an empty ArrayList that we can start adding earthquakes to
        ArrayList<Detail> earthquakes = new ArrayList<>();
        ...
        try {
            ...
            /*
            DoneTODO: Parse the response given by the SAMPLE_JSON_RESPONSE string and
            build up a list of Earthquake objects with the corresponding data.
            DoneTODO: 10-03-2018 Do the Steps Below
                ...
                Create Detail java object from magnitude, location, and time
            ...
            for (int i = 0; i < EarthquakeArray.length(); i++) {
                ...
                @SuppressLint("SimpleDateFormat") SimpleDateFormat simpleTimeFormat = new SimpleDateFormat("hh:mm a");
                String timeDisplay = simpleTimeFormat.format(date);
                String dateDisplay = dateFormat.format(date);
                String url = properties.getString("url");


                Detail earthquakeArray = new Detail(magnitude, place, dateDisplay, timeDisplay, url);
                earthquakes.add(earthquakeArray);
            ...
            Log.e("JsonQuery", "Problem parsing the earthquake JSON results", e);
        }
    ...
    /**Using URL stuff to parsing JSON data **/
    ...
    public static List<Detail> fetchEarthquakeData(String requestUrl){
       ...
       /* try {
        ...
        List<Detail> listEarthquakes = extractEarthquakesFromJson(jsonResponse);
